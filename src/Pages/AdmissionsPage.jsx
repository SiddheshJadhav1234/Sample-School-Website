...
import { FaCheckCircle, FaFileAlt, FaUserCheck, FaCalendarAlt, FaGraduationCap, FaDownload } from 'react-icons/fa';
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-6 rounded-xl">
                      ...
                      <div className="space-y-2 text-sm text-gray-700">
                        ...
                        <p>📧 Email: admissions@mmvidyamandir.edu.in</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="mt-8">
                <button className="bg-gradient-to-r from-amber-400 to-amber-600 text-white px-8 py-4 rounded-full font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center gap-2">
            ...
            <div className="bg-gradient-to-br from-amber-100 to-amber-200 rounded-2xl p-8 h-96 flex items-center justify-center">
